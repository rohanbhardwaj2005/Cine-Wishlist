...
export default function UserMoviesList({
    ...
    return (
        <>
            <div>
                {/* <ChildLock isChildLockOn={isChildLockOn} /> */}
            </div>
            <div className="uml">
                <Button
                    onClick={handleOpenMoviesList}
                    label={`My list (${watchedListLength})`}
                    ...
                    <div className="uml-content">
                        {watchedListLength <= 0 ? (
                            <EmptyStateList
                                ...
                                heading="Oops! Your list is empty."
                                subheading="Add movies to your list to see them here."
                            />
                        ) : (
